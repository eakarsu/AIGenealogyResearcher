...
A research question, persons and privacy flags, sourced records with terms/citations, evidence-backed relationships, hypotheses and unresolved conflicts.

Date consistency, living-person export, relationship references and citation completeness are deterministic checks, with a GEDCOM-compatible JSON summary. Archive/OCR/map/document/collaboration adapters, source licenses, record availability, OCR validation and professional genealogy review remain blocked externally.
