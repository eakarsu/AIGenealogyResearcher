...
// Auto-generated page for: Limited support for non-US archives

export default function GapLimitedSupportForNonUsArchives() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-support-for-non-us-archives', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Limited support for non-US archives</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Limited support for non-US archives</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Limited support for non-US archives'}
        </button>
      </form>
