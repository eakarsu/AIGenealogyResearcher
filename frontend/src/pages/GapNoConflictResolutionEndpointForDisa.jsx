...
// Auto-generated page for: No conflict-resolution endpoint for disagreeing records

export default function GapNoConflictResolutionEndpointForDisa() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-conflict-resolution-endpoint-for-disa', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No conflict-resolution endpoint for disagreeing records</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No conflict-resolution endpoint for disagreeing records</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No conflict-resolution endpoint for disagreeing records'}
        </button>
      </form>
