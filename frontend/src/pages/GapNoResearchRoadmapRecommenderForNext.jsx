...
// Auto-generated page for: No research-roadmap recommender for next steps

export default function GapNoResearchRoadmapRecommenderForNext() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-research-roadmap-recommender-for-next', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No research-roadmap recommender for next steps</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No research-roadmap recommender for next steps</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No research-roadmap recommender for next steps'}
        </button>
      </form>
