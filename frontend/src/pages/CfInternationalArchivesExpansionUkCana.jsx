...
// Auto-generated page for: International archives expansion (UK, Canada, Ireland, Germa

export default function CfInternationalArchivesExpansionUkCana() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-international-archives-expansion-uk-cana', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>International archives expansion (UK, Canada, Ireland, Germa</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>International archives expansion (UK, Canada, Ireland, Germany, Italy) beyond US-centric data.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run International archives expansion (UK, Canada, Ireland, Germa'}
        </button>
      </form>
