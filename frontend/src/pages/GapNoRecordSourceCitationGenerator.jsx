...
// Auto-generated page for: No record-source citation generator

export default function GapNoRecordSourceCitationGenerator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-record-source-citation-generator', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No record-source citation generator</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No record-source citation generator</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No record-source citation generator'}
        </button>
      </form>
