...
// Auto-generated page for: No expert review workflow (professional genealogist review)

export default function GapNoExpertReviewWorkflowProfessionalG() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-expert-review-workflow-professional-g', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No expert review workflow (professional genealogist review)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No expert review workflow (professional genealogist review)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No expert review workflow (professional genealogist review)'}
        </button>
      </form>
