...
// Auto-generated page for: DNA + document fusion linking matches to researched ancestor

export default function CfDnaDocumentFusionLinkingMatchesTo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-dna-document-fusion-linking-matches-to', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>DNA + document fusion linking matches to researched ancestor</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>DNA + document fusion linking matches to researched ancestors and auto-filling trees.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run DNA + document fusion linking matches to researched ancestor'}
        </button>
      </form>
