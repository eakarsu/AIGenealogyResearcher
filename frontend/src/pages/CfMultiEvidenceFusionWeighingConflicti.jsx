...
// Auto-generated page for: Multi-evidence fusion weighing conflicting records with conf

export default function CfMultiEvidenceFusionWeighingConflicti() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-evidence-fusion-weighing-conflicti', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Multi-evidence fusion weighing conflicting records with conf</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Multi-evidence fusion weighing conflicting records with confidence scoring.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Multi-evidence fusion weighing conflicting records with conf'}
        </button>
      </form>
